 ...
 */
public class ParseWikiToHTMLUtility {
	...
	/**
	 * MarkupLanguage API prefers we retrieve the MarkupLanguge by name from the ServiceLocator; since there are no name
	 * constants, we obtain the names from this method or alternately use the hard-coded names from this utility class,
